                        ...
                        <div className="dir-info">
                            ...
                            <div className="info-part"  style={{ backgroundImage: `url(${csec})`}}>  
                                <div className="more-info-one">
                                    ...
                                    <p>Секция: КибербезопасностьЦелями проведения соревнования являются развитие CTF-движения в Кыргызстане и привлечение студентов к этичному хакингу</p>
                            ...
                            <div className="info-part"  style={{ backgroundImage: `url(${cs})`}}>  
                                <div className="more-info-two">
                                    ...
                                    <ToggleText isActive={activeId === "4"}>
                                        <p>Секция: КиберспортТурнир проводится с целью популяризации и развития киберспорта среди молодёжи и более старшего возраста</p>
                                    </ToggleText>
                                </div>
                            </div>
                            <div className="act-part">
